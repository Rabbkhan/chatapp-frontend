...
const SearchUser = ({onClose}) => {
    ...
    return (
        <div className='fixed top-0 bottom-0 left-0 right-0 bg-slate-700 bg-opacity-40 p-2 z-40'>
            <div className='w-full max-w-lg mx-auto mt-10 px-2'>
     ...
     h-full px-2'
                ...
                {/* display search user  */}
                <div className='bg-white mt-2 w-full p-4 overflow-y-scroll max-h-96 z-40'>
                    {/* {no user found} */}
                    {
